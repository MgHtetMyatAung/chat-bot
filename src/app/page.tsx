...
import { Bot, Zap, Shield, Sparkles, MessageSquare, ArrowRight, Play, Database, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#020617] text-white selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-slate-950/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">Nexus <span className="text-blue-500">AI</span></span>
          </div>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-bold uppercase tracking-widest mb-8 animate-in fade-in slide-in-from-bottom-2 duration-700">
            <Sparkles size={14} />
            The Future of Customer Support
          </div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            Nexus AI learns from your documents, links, and PDFs to provide instant, accurate answers to your customers 24/7.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            <Link href="/dashboard" className="group px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all shadow-xl shadow-blue-600/20 flex items-center gap-2 text-lg">
              Launch Your Chatbot
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <button className="px-8 py-4 bg-slate-900/50 hover:bg-slate-800 border border-white/5 text-white font-bold rounded-2xl transition-all backdrop-blur-sm flex items-center gap-2 text-lg">
              <Play size={20} className="fill-current" />
              Watch Demo
            </button>
          </div>

          <div className="mt-20 relative max-w-4xl mx-auto group animate-in fade-in zoom-in-95 duration-1000 delay-500">
            ...
            <div className="relative bg-slate-900 border border-white/10 rounded-[2rem] p-4 shadow-2xl overflow-hidden aspect-video flex items-center justify-center">
               {/* Mockup Placeholder */}
               <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 pointer-events-none" />
               <Bot size={120} className="text-blue-500/20" />
               <div className="absolute bottom-8 left-8 right-8 p-4 bg-white/5 backdrop-blur-md rounded-xl border border-white/10 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-blue-500 flex items-center justify-center">
                      <MessageSquare size={20} />
                    </div>
                    <div className="text-left">
                       <p className="text-xs text-white font-bold tracking-tight">AI Assistant</p>
                       <p className="text-[10px] text-slate-400 uppercase tracking-widest">Active & Learning</p>
                    </div>
                  </div>
      ...
      <section id="features" className="py-24 px-6 bg-slate-950/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Everything you need <br /> to support your customers.</h2>
            <p className="text-slate-400">Powerful features to help you automate support without losing the personal touch.</p>
          </div>
      ...
      <footer className="py-12 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-slate-500 text-sm">© 2024 Nexus AI System. Built for the modern web.</p>
